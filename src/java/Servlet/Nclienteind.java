 ...
 * @author geoffrey
 */
public class Nclienteind extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Statement statement = Conexion.conn.createStatement();
            ...
            "id, nombre, nit, direccion, telefono, dpi, estado, tipo)\n" +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?);";
            ...
            {     
                ...
                pst.setString(6,request.getParameter("txtdpi"));
                pst.setString(7,request.getParameter("txtestado"));
                pst.setString(8,request.getParameter("txtTipo"));
                pst.execute();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Nclienteind.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
