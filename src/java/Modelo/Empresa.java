...
public class Empresa extends Cliente {
    ...
    public Empresa(String contacto, int descuento, String nombre, String nit, String direccion, String telefono, String estado, String tipo) {
        super(nombre, nit, direccion, telefono,estado,tipo);
